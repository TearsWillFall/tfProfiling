#' Plot Mean Methylation Ratio for TFBS
#'
#' This function takes a DATA.FRAME with Mean Methylation Ratio data as input, and plots it
#'
...
plot_motif_MR=function(data="",trend_line=TRUE,tf_name="",sample_name="",output_dir="",line=TRUE){
  ...
  ggplot2::ggtitle(label=paste(tf_name,"for sample",sample_name,"(",max(data$TFBS_ANALYZED),"TFBS analyzed)"),subtitle=paste0("WIDTH=",max(data$BIN_WIDTH)," pb")) +
